...
3.  **Simulation:** Simulating an NFA involves maintaining a _set_ of active states. For each input character, we transition all active states and then compute the $\epsilon$-closure (all states reachable by $\epsilon$-transitions).
