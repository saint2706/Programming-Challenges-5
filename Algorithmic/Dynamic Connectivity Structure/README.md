...
_Note: A true $O(\log^2 V)$ implementation requires Euler Tour Trees or Link-Cut Trees with level structures, which significantly exceeds the code size of a typical challenge solution._
