...
class DNSResolver:
    ...
    def cache_size(self) -> int:
        """
        Docstring for cache_size.
        """
        return len(self.cache)

    def purge_expired(self) -> None:
        """
        Docstring for purge_expired.
        """
