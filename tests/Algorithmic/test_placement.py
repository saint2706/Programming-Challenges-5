...
_label_placement = importlib.import_module(
    "Algorithmic.Map Label Placement.label_placement"
)
Label = _label_placement.Label
MapLabeler = _label_placement.MapLabeler
intersect = _label_placement.intersect
