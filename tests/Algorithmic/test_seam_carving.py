...
_seam_carving = importlib.import_module("Algorithmic.Image Seam Carving.seam_carving")
calculate_energy = _seam_carving.calculate_energy
find_vertical_seam = _seam_carving.find_vertical_seam
remove_vertical_seam = _seam_carving.remove_vertical_seam
