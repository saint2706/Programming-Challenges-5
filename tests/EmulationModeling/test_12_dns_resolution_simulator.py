...
_dns_simulator = importlib.import_module(
    "EmulationModeling.12_dns_resolution_simulator.dns_simulator"
)
AuthoritativeDNSServer = _dns_simulator.AuthoritativeDNSServer
DNSResolver = _dns_simulator.DNSResolver
RootServer = _dns_simulator.RootServer
TLDServer = _dns_simulator.TLDServer
