...
sys.modules["fs_nodes"] = importlib.import_module(
    "EmulationModeling.03_virtual_file_system.fs_nodes"
)
VirtualFileSystem = importlib.import_module(
    "EmulationModeling.03_virtual_file_system.fs"
).VirtualFileSystem
