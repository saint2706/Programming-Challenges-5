...
_os_sim = importlib.import_module("EmulationModeling.07_os_process_scheduler.os_sim")
Kernel = _os_sim.Kernel
Process = _os_sim.Process
Scheduler = _os_sim.Scheduler
