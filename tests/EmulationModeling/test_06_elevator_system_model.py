...
_elevator_system = importlib.import_module(
    "EmulationModeling.06_elevator_system_model.elevator_system"
)
Controller = _elevator_system.Controller
Elevator = _elevator_system.Elevator
