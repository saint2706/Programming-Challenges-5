...
_physics = importlib.import_module("GameDevelopment.13_PhysicsPuzzle.physics")
sys.modules["physics"] = _physics
Body = _physics.Body
Rect = _physics.Rect
Vec2 = _physics.Vec2
World = _physics.World

_levels = importlib.import_module("GameDevelopment.13_PhysicsPuzzle.levels")
BallSpec = _levels.BallSpec
GameStatus = _levels.GameStatus
Level = _levels.Level
PuzzleGame = _levels.PuzzleGame
discover_levels = _levels.discover_levels
