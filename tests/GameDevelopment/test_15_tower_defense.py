...
_core = importlib.import_module("GameDevelopment.15_TowerDefense.core")
ENEMY_KINDS = _core.ENEMY_KINDS
SELL_REFUND = _core.SELL_REFUND
TICK = _core.TICK
TOWER_KINDS = _core.TOWER_KINDS
BuildError = _core.BuildError
Enemy = _core.Enemy
GameStatus = _core.GameStatus
Level = _core.Level
Projectile = _core.Projectile
Route = _core.Route
SpawnGroup = _core.SpawnGroup
TargetMode = _core.TargetMode
TowerDefenseGame = _core.TowerDefenseGame
Vec2 = _core.Vec2
Wave = _core.Wave
discover_levels = _core.discover_levels
parse_tile = _core.parse_tile
tile_label = _core.tile_label
