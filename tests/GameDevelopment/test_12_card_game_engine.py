...
_engine = importlib.import_module("GameDevelopment.12_CardGameEngine.engine")
...
_main = importlib.import_module("GameDevelopment.12_CardGameEngine.main")
WILD_RANK = _main.WILD_RANK
CrazyEights = _main.CrazyEights
