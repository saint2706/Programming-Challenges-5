...
def parse_log_line(line: str) -> Optional[Dict]:
    ...
    try:
        dt_str = data['datetime'].split(' ')[0] # simpler handling, ignoring timezone for basic aggregation if needed
...
def analyze_logs(file_path: str, output_image: str):
    ...
    # Status Codes
    axes[2].pie(status_counts.values, labels=status_counts.index, autopct='%1.1f%%', startangle=140)
