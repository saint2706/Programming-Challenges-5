...
class VaultApp:
    ...
    def setup_screen(self):
        self.clear_screen()
        tk.Label(self.root, text="Create Master Password", font=("Arial", 16)).pack(
            pady=20
        )
        ...
        tk.Button(self.root, text="Create Vault", command=self.create_vault).pack(
            pady=10
        )
    ...
    def login_screen(self):
        self.clear_screen()
        tk.Label(self.root, text="Enter Master Password", font=("Arial", 16)).pack(
            pady=20
        )
    ...
    def main_screen(self):
        ...
        tk.Button(btn_frame, text="New Note", command=self.new_note).pack(
            side=tk.LEFT, padx=5
        )
        tk.Button(btn_frame, text="Delete Note", command=self.delete_note).pack(
            side=tk.LEFT, padx=5
        )
        tk.Button(btn_frame, text="Lock Vault", command=self.login_screen).pack(
