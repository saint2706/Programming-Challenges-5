...
| 19 | Style Transfer Engine | (H) | Implemented (Python) | Implements Gatys' paper using VGG19; optimizes an image to match content (deep layers) and style (Gram matrix). |
