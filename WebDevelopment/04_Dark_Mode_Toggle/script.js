...
if (demoForm) {
  demoForm.addEventListener("submit", (e) => {
    ...
    successAlert.innerHTML =
      "<strong>Success:</strong> Form submitted (demo only)";
...
console.log(
  "%c🌓 Dark Mode Toggle Demo",
  "color: #3b82f6; font-size: 18px; font-weight: bold;",
);
console.log(
  "%cKeyboard shortcut: Ctrl/Cmd + Shift + D",
  "color: #6b7280; font-size: 12px;",
);
console.log(
  `%cCurrent theme: ${initialTheme}`,
  "color: #6b7280; font-size: 12px;",
);
console.log(
  `%cSystem preference: ${systemPreference}`,
  "color: #6b7280; font-size: 12px;",
);
