...
console.log('%cPrism UI Component Library', 'color: #3b82f6; font-size: 18px; font-weight: bold;');
console.log('%cBuilt with BEM methodology and CSS custom properties', 'color: #6b7280; font-size: 12px;');
